...
export function SpecificationsUIProvider({ currentTodoId, children }) {
  const [productId, setTodoId] = useState(currentTodoId);
  ...
  useEffect(() => {
    initSpecification.carId = currentTodoId;
    initSpecification.productId = currentTodoId;
    setTodoId(currentTodoId);
